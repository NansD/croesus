...
export default function NavBar({isAuthenticated}) {
  ...
  <nav className="navbar" role="navigation" aria-label="main navigation">
    <div className="is-flex" style={{alignItems: 'center'}}>
      <a role="button" className={ `${showMenu ? 'is-active' : ''} navbar-burger burger ml-0`} aria-label="menu" aria-expanded="false" data-target="navbar-menu" onClick={() => setShowMenu(!showMenu)}>
